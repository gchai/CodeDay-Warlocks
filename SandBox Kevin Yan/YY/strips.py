...
from demo_copy import*

FPS = 120
frames = FPS / 12

left_strips = SpriteStripAnim(user, (0,64,64,64), 9, -1, True, frames)
right_strips = SpriteStripAnim(user, (0,192,64,64), 9, -1, True, frames)
up_strips = SpriteStripAnim(user, (0,0,64,64), 9, -1, True, frames)
down_strips = SpriteStripAnim(user, (0,128,64,64), 9, -1, True, frames)
...
# #Magic Animation:
# 	#Fireball:
# fire_left_strips = SpriteStripAnim('lightning.png', (0,0,64,64), 8, -1, True, frames)
# fire_right_strips = SpriteStripAnim('lightning.png', (0,256,64,64), 8, -1, True, frames)
# fire_up_strips = SpriteStripAnim('lightning.png', (0,128,64,64), 8, -1, True, frames)
# fire_down_strips = SpriteStripAnim('lightning.png', (0,384,64,64), 8, -1, True, frames)

# #Lightning:
# lightning_left_strips = SpriteStripAnim('lightning.png', (0,192,64,64), 8, -1, True, frames)
# lightning_right_strips = SpriteStripAnim('lightning.png', (0,0,64,64), 8, -1, True, frames)
# lightning_up_strips = SpriteStripAnim('lightning.png', (0,384,64,64), 8, -1, True, frames)
# lightning_down_strips = SpriteStripAnim('lightning.png', (0,128,64,64), 8, -1, True, frames)
