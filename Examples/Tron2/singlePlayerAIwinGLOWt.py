...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~testing ColorModGui~~~~~~~~~~~`````
import ColorMod/ColorModGui.py
lightUp = ColorModGui.GetIMG(screen, "lights/GLOWGREEN")
class LightBike(pygame.sprite.Sprite):
    ...
    def update(self, COL):
        ...
        if self.TB >= 200:
            ...
            self.level += 1
            if not lb2.living:
                lb2.begin(SPEED*10, SPEED*10, lb2.dir)
            if not lb.living:
...
lb2 = LightBike( 2, "lights/GLOWBLUE")
...
def main():
    ...
    while play:
        ...
        if pygame.key.get_pressed()[pygame.K_ESCAPE]:
            play = False
            Play = False
        if lb.living == False and lb2.living == False:
