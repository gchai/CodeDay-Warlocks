...
class Car():
    def __init__(self, Control = -1, x = 0, y = 0, color = (50,120,160) ):
        ...
        spr = ColorMod.Filter(pygame.image.load('cars/base.png'), color)
        ...
        self.img.blit(self.imglist[0], (7,7))
    ...
    def update(self, screen, spGroup):
        if (pygame.time.get_ticks()-self.actionTime)/1000 > self.actionCoolDown:
            ...
            self.canAct = False
        if (pygame.time.get_ticks()-self.actionTime)/1000 > 3:
            self.strength = 1
            self.speed = 12
        if (pygame.time.get_ticks()-self.actionTime)/1000 < 3:
            self.speed = 24
    ...
    def Draw(self, screen):
        ...
        if self.living:
            if self.dir == "U":
                self.img.blit(self.imglist[1],(7,7))
            elif self.dir == "D":
                self.img.blit(self.imglist[2],(7,7))
            elif self.dir == "L":
                self.img.blit(self.imglist[3],(7,7))
            elif self.dir == "R":
                self.img.blit(self.imglist[4],(7,7))        
